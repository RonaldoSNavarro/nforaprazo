...
*   `StatusCTe`: `REGISTRADO` | `AGUARDANDO_DESEMBARACO` | `AUTO_RECEBIDO` | `EM_INVESTIGACAO` | `AGUARDANDO_PAGAMENTO` | `PAGO` | `ENCERRADO_COM_AUTO` | `ENCERRADO_SEM_AUTO`
*   `Responsavel`: `PENDENTE` | `SISTEMA` | `CLIENTE`
