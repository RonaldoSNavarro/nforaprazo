package com.alianca.nforaprazo.integration;
...
import com.alianca.nforaprazo.repository.*;
...
class EndToEndIntegrationTest {
    ...
    private static final String EMAIL_FATURAMENTO = "faturamento@alianca.com.br";
    private static final String EMAIL_DESCARGA = "descarga@alianca.com.br";
    private static final String EMAIL_DOCS_FISCAL = "docsfiscal@alianca.com.br";
    ...
    void testFluxoA_Completo() throws Exception {
        ...
        assertTrue(cte.isPortoMonitorado());
        ...
        long alertasDocs = logAlertaRepository.findAll().stream()
                .filter(a -> a.getDestinatario().contains("docs-fiscal"))
                .count();
