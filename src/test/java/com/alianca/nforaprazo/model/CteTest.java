...
class CteTest {
    ...
    @Test
    @DisplayName("Deve identificar portos monitorados corretamente")
    void deveIdentificarPortoMonitorado() {
        ...
        assertTrue(cteManaus.isPortoMonitorado());
        assertTrue(cteMao.isPortoMonitorado());
        assertTrue(cteVilaConde.isPortoMonitorado());
        assertTrue(ctePcm.isPortoMonitorado());
        assertTrue(ctePecem.isPortoMonitorado());
        assertTrue(ctePecemSemAcento.isPortoMonitorado());

        assertFalse(cteSantos.isPortoMonitorado());
        assertFalse(cteItapoa.isPortoMonitorado());
        assertFalse(cteNulo.isPortoMonitorado());
    }
}
