...
class DocsFiscalServiceTest {
    ...
    void deveIniciarInvestigacaoComSucesso() {
        ...
        Cte resultado = docsFiscalService.iniciarInvestigacao(cteId, "docs@sistema.local");
    ...
    void deveFalharAoIniciarInvestigacaoSeStatusInvalido() {
        ...
        assertThrows(IllegalStateException.class, () -> 
            docsFiscalService.iniciarInvestigacao(cteId, "docs@sistema.local")
        );
    ...
    void deveFalharSeResponsavelForPendente() {
        ...
        assertThrows(IllegalArgumentException.class, () -> 
            docsFiscalService.concluirInvestigacao(request, "docs@sistema.local")
        );
    }
    ...
    void deveConcluirInvestigacaoComSucesso() {
        ...
        AutoInfracao autoResultado = docsFiscalService.concluirInvestigacao(request, "docs@sistema.local");
